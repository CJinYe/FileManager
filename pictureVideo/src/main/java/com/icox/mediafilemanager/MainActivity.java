...
public class MainActivity extends BaseActivity {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            for (int i = 0; i < pageItem; i++) {
                ...
                if (bitmaps[itemTag] != null) {
                    ...
                    //                        int digree = ShareUtil.getBitmapDigree(mImagePath.get(itemTag));
                    //                        Picasso.with(mContext)
                    //                                .load(new File(mImagePath.get(itemTag)))
                    //                                .resize(300, 300)
                    ////                                .rotate(digree)
    ...
    private void btnGoBackSetBackground() {
        mBtnGoBack.setBackgroundResource(R.drawable.selector_but_go_back);
    }

    private void btnGoBackSetFocus() {
        mBtnGoBack.setImageResource(R.drawable.selector_but_go_back);
        mBtnGoBack.setBackgroundResource(R.drawable.sel_focus);
    }

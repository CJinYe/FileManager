...
import com.icox.manager.adapter.GridShowAdapter;
 ...
 */
public class FileOldActivityCopy extends Activity {
            ...
            switch (msg.what) {
                ...
                case INIT_ADPTER:
                    ...
                    if (gridShowAdapter == null) {
                        // 首次运行的话,实例化适配器
                        gridShowAdapter = new GridShowAdapter(context, listFiles, gridShow, false);
                ...
                case ERROR_STATE:
                    ...
                    Toast.makeText(FileOldActivityCopy.this, "目标路径有误,请重新操作! " + currentPath.getText().toString(), Toast.LENGTH_SHORT).show();
                    break;
                case UPDATE_STATE:
                    showFilesLayoutChild_B.setVisibility(View.GONE);
                    updateGridShowUI();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 获取当前运行上下文
        context = FileOldActivityCopy.this;
        // 获取路径
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder icoxBuilder = new AlertDialog.Builder(FileOldActivityCopy.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                FileUtil.delete(FileOldActivityCopy.this, copyPath);
    ...
    private void setListener() {
        ...
        new_folder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //                    public void onClick(DialogInterface dialog, int which) {
                //
                //                        File file = new File(currentPath.getText() + "/" + et.getText());
                //
                ...
                mNewFileDialog = new NewFileDialog(FileOldActivityCopy.this) {
                    @Override
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (parentPath != null
                    ...
                    FileOldActivityCopy.this.finish();
                }
            }
        });
                                             ...
                                             public void run() {
                                                 try {
                                                     ...
                                                     if (hasFile.canRead()) {
                                                         ...
                                                         FileUtil.copy(FileOldActivityCopy.this, copyPath, currentPath.getText() + "/");
                                                         handler.sendEmptyMessage(UPDATE_STATE);
                                                         FileUtil.round = true;
                                                     } else {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (hasFile.canRead()) {
                            ...
                            FileUtil.move(FileOldActivityCopy.this, copyPath, currentPath.getText() + "/");
                            FileUtil.delete(FileOldActivityCopy.this, copyPath);
                            handler.sendEmptyMessage(UPDATE_STATE);
                            FileUtil.round = true;
                            return;
    ...
    private void showMenuDialog(final File file) {
        FileMenuDialog fileMenuDialog = new FileMenuDialog(FileOldActivityCopy.this) {
            @Override
    ...
    private void showFileInfo(File file) {
        ...
        FileDetailDialog fileDetailDialog = new FileDetailDialog(
                FileOldActivityCopy.this, title, path, size, time
        );
    ...
    private void clickMenuDelete(final File file) {
        FileDeleteDialog fileDeleteDialog = new FileDeleteDialog(FileOldActivityCopy.this) {
            @Override
            public void clickCancel() {
    ...
    private void clickMenuRename(final File file) {
        FileRenameDialog fileRenameDialog = new FileRenameDialog(FileOldActivityCopy.this) {
            @Override
            public void clickCancel() {

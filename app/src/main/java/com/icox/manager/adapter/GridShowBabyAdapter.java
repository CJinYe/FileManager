...
import com.icox.manager.myview.floatable_textview.FloatableTextView;
...
import static com.icox.manager.R.id.item_floatableTextView;

/**
 * Created by icox-XiuChou  on 2016/1/4
 */
public class GridShowBabyAdapter extends BaseAdapter {
     ...
     */
    public GridShowBabyAdapter(Context context, File[] listFiles, GridView gridView, boolean isShow) {
    ...
    public View getView(final int position, View itemView, ViewGroup viewGroup) {
        ...
        if (itemView == null) {
            ...
            // 找到Item布局
            itemView = inflater.inflate(R.layout.file_grid_item_baby, viewGroup,false);
            // 实例化控件
            holder.item_imageView = (ImageView) itemView.findViewById(R.id.item_imageView);
            holder.item_floatableTextView = (FloatableTextView) itemView.findViewById(item_floatableTextView);
        ...
        if (listFiles[position].isDirectory()) {
            ...
            if (fileName.endsWith(".doc") || fileName.endsWith(".docx")) {
                ...
                Drawable drawable = ApkUtil.getUninstallApkIcon(context, listFiles[position].getAbsolutePath());
                holder.item_imageView.setImageDrawable(drawable);
...
//        });
    ...
    private  class ViewHolder{
        ...
        public FloatableTextView item_floatableTextView;
    }
